...
char msgstrlib9[]= "We offer the following services A1: A2: A3: A4: A5";
...
char msgstrlib2[]= "Powered by SangamOne Connected Services p1 Powered by SangamOne Connected Services p2 ";
